        ...
        <div class="col-12">
            <div class="card card-success card-outline">
                <div class="card-header">
                    <h3 class="card-title">Listado de todos los pagos completados</h3>
                ...
                <div class="card-body">
                    <table id="paid-payments-table" class="table table-bordered table-hover w-100">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Usuario</th>
...
document.addEventListener('DOMContentLoaded', function() {
    var table = $('#paid-payments-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('payments.paid') }}",
        columns: [
        ...
        language: { "emptyTable": "No hay pagos completados.", "info": "Mostrando _START_ a _END_ de _TOTAL_ registros", "infoEmpty": "Mostrando 0 a 0 de 0 registros", "infoFiltered": "(filtrado de _MAX_ registros totales)", "lengthMenu": "Mostrar _MENU_ registros", "loadingRecords": "Cargando...", "processing": "Procesando...", "search": "Buscar:", "zeroRecords": "No se encontraron registros coincidentes", "paginate": { "first": "Primero", "last": "Último", "next": "Siguiente", "previous": "Anterior" } }
    });
